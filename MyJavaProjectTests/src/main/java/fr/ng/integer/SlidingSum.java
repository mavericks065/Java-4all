...
public class SlidingSum {
    ...
    public static void main(final String[] args) {
        final List<Integer> integersToTransform = new ArrayList<>();
        int integer = 10;
        ...
        final List<Integer> firstWayToTransform = SlidingSum.imbricatedWay(
        ...
        final List<Integer> secondWayToTransform = SlidingSum.substratedWayWay(
                integersToTransform, slidingInt);
    ...
    public static List<Integer> imbricatedWay(final List<Integer> listToTransform,
        ...
        List<Integer> slidingAverageList = new ArrayList<>();
